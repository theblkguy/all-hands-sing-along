...
#     E.g.: docker.io/hexpm/elixir:1.18.4-erlang-27.3-debian-trixie-20260610-slim
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/all_hands_sing_along ./

# Start as root so the Fly volume at /data is writable, then drop to nobody.
USER root
